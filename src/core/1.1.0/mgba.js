 ...
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */ Module.loadGame = name => {
...
const keyBindings = new Map([ [ "a", 0 ], [ "b", 1 ], [ "select", 2 ], [ "start", 3 ], [ "right", 4 ], [ "left", 5 ], [ "up", 6 ], [ "down", 7 ], [ "r", 8 ], [ "l", 9 ] ]);
...
Module.getPixelData = () => {
  ...
  return new Uint32Array(GROWABLE_HEAP_U32().buffer, ptr, 240 * 160);
};
...
var ASM_CONSTS = {
  ...
  284143: () => window.innerWidth,
  284173: () => window.innerHeight
};
...
var PThread = {
  ...
  allocateUnusedWorker() {
    ...
    worker = new Worker(new URL("mgba.js", import.meta.url), workerOptions);
    PThread.unusedWorkers.push(worker);
  },
  getNewWorker() {
...
function ___syscall_ftruncate64(fd, length_low, length_high) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(5, 0, 1, fd, length_low, length_high);
...
function __mmap_js(len, prot, flags, fd, offset_low, offset_high, allocated, addr) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(18, 0, 1, len, prot, flags, fd, offset_low, offset_high, allocated, addr);
...
function __msync_js(addr, len, prot, flags, fd, offset_low, offset_high) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(19, 0, 1, addr, len, prot, flags, fd, offset_low, offset_high);
  var offset = convertI32PairToI53Checked(offset_low, offset_high);
  try {
    if (isNaN(offset)) return 61;
...
var _emscripten_get_main_loop_timing = (mode, value) => {
  if (mode) GROWABLE_HEAP_I32()[((mode) >> 2)] = MainLoop.timingMode;
  if (value) GROWABLE_HEAP_I32()[((value) >> 2)] = MainLoop.timingValue;
};
...
function _fd_seek(fd, offset_low, offset_high, whence, newOffset) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(79, 0, 1, fd, offset_low, offset_high, whence, newOffset);
  var offset = convertI32PairToI53Checked(offset_low, offset_high);
  try {
    if (isNaN(offset)) return 61;
    var stream = SYSCALLS.getStreamFromFD(fd);
...
var _GBAInputInfo = Module["_GBAInputInfo"] = 112400;

var _binaryName = Module["_binaryName"] = 188432;

var _projectName = Module["_projectName"] = 188436;

var _projectVersion = Module["_projectVersion"] = 188440;

var _gitCommit = Module["_gitCommit"] = 188416;

var _gitCommitShort = Module["_gitCommitShort"] = 188420;

var _gitBranch = Module["_gitBranch"] = 188424;

var _gitRevision = Module["_gitRevision"] = 188428;

var _GBIORegisterNames = Module["_GBIORegisterNames"] = 50768;

var _GBSavestateMagic = Module["_GBSavestateMagic"] = 66032;

var _GBSavestateVersion = Module["_GBSavestateVersion"] = 66036;

var _GBA_LUX_LEVELS = Module["_GBA_LUX_LEVELS"] = 95504;

var _GBAVideoObjSizes = Module["_GBAVideoObjSizes"] = 139840;

var _GBASavestateMagic = Module["_GBASavestateMagic"] = 139616;

var _GBASavestateVersion = Module["_GBASavestateVersion"] = 139620;
