...
var ASM_CONSTS = {
 ...
 317883: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 317966: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 318035: () => { return window.innerWidth; },  
 318065: () => { return window.innerHeight; }
};
